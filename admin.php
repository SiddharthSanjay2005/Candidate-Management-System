...
<div class="admin_profile">
	<div class="details">
		<button><a href="fct_reg.php">Add Faculty</a><br></button>
		<button><a href="admin_all_faculty.php">View Faculty</a><br></button>
		<button><a href="st_reg.php">Add Student</a></button>
		<button><a href="#">Generate Report</a></a></button>
	</div>
	<br>
	<div class="section">
			<h3>Student</h3>
