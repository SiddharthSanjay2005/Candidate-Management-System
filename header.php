		...
		<div class="maincontent container fix">
			<div id="stickerside">
				<div class="sidebar fix" >
						<ul>
							<li><span class="spcl"><i class="fa fa-server" aria-hidden="true"></i> <b>Administrator</b></span></li>
								<ul>
									<li><a href="index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</a></li>
								</ul>
							
							<li><span class="spcl"><i class="fa fa-male" aria-hidden="true"></i> <b>Faculty</b> </span></li>
								<ul>
							...
							<li><span class="spcl"><i class="fa fa-graduation-cap" aria-hidden="true"></i> <b>Student</b> </span></li>
								<ul>
									...
									<li><a href="attendance_marks.php"><i class="fa fa-outdent" aria-hidden="true"></i> Stats</a></li>
								</ul>
